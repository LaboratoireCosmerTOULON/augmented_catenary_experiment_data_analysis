...
for cable in range( 1, 9 ):
	...
	for axis in [ 'x', 'y' ]:
		...
		for speed in [ '100', '200' ]:
			datas[ f'{cable}' ][ axis ][ speed ] = {
					'dis1': np.nan,
					'dis2': np.nan
					}
			stats[ f'{cable}' ][ axis ][ speed ] = {
					'dis1': np.nan,
					'dis2': np.nan
					}
...
for file in directory:
	...
	datas[ cable ][ 'theta_gamma' ] = theta_gamma[ 'mean' ] if type(
			datas[ cable ][ 'theta_gamma' ]
			) == float else pd.concat(
...
for cable, cable_data in datas.items():
	...
	stats[ cable ][ 'theta_gamma' ][ 'IQR' ] = stats[ cable ][ 'theta_gamma' ][ 'Q75' ] - stats[ cable ][
		'theta_gamma' ][
		'Q25' ]
		...
		for speed, speed_data, in axis_data.items():
			for distance, distance_data in speed_data.items():
				if type( distance_data[ 'vertical' ] ) != float:
					stats[ cable ][ axis ][ speed ][ distance ][ 'vertical' ][ 'Q1' ] = distance_data[ 'vertical' ].quantile(
						1 / 100
						)
					stats[ cable ][ axis ][ speed ][ distance ][ 'vertical' ][ 'Q25' ] = distance_data[ 'vertical' ].quantile(
						1 / 4
						)
					stats[ cable ][ axis ][ speed ][ distance ][ 'vertical' ][ 'Q50' ] = distance_data[ 'vertical' ].quantile(
						2 / 4
						)
					stats[ cable ][ axis ][ speed ][ distance ][ 'vertical' ][ 'Q75' ] = distance_data[ 'vertical' ].quantile(
						3 / 4
						)
				...
				if type( distance_data[ 'theta' ] ) != float:
					...
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta' ][ 'Q99' ] = distance_data[ 'theta' ].quantile(
						99 / 100
						)
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta' ][ 'IQR' ] = \
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta' ][ 'Q75' ] - \
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta' ][ 'Q25' ]
				...
				if type( distance_data[ 'gamma' ] ) != float:
					...
					stats[ cable ][ axis ][ speed ][ distance ][ 'gamma' ][ 'Q99' ] = distance_data[ 'gamma' ].quantile(
						99 / 100
						)
					stats[ cable ][ axis ][ speed ][ distance ][ 'gamma' ][ 'IQR' ] = \
					stats[ cable ][ axis ][ speed ][ distance ][ 'gamma' ][ 'Q75' ] - \
					stats[ cable ][ axis ][ speed ][ distance ][ 'gamma' ][ 'Q25' ]

				if type( distance_data[ 'theta_gamma' ] ) != float:
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta_gamma' ][ 'Q1' ] = distance_data[
						'theta_gamma' ].quantile(
							1 / 100
							)
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta_gamma' ][ 'Q25' ] = distance_data[
						'theta_gamma' ].quantile(
							1 / 4
							)
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta_gamma' ][ 'Q50' ] = distance_data[
						'theta_gamma' ].quantile(
							2 / 4
							)
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta_gamma' ][ 'Q75' ] = distance_data[
						'theta_gamma' ].quantile(
							3 / 4
							)
					stats[ cable ][ axis ][ speed ][ distance ][ 'theta_gamma' ][ 'Q99' ] = distance_data[
						'theta_gamma' ].quantile(
							99 / 100
							)
	...
	for axis, axis_data in files_data.items():
		...
		for speed, speed_data, in axis_data.items():
			...
			for distance, distance_data in speed_data.items():
				...
				print(
						f'\t\t\t\ttheta_gamma: {distance_data[ "theta_gamma" ][ "fill" ]}'
						f'/{distance_data[ "theta_gamma" ][ "nframes" ]}; '
